<?php
require_once '../OperationsUser/CountertopsEggerOperations.php';
...
<div class="table-container">
    <table class="table custom-table">
        ...
        <tbody>
        <?php
        $result = $connection->query("SELECT * FROM countertopsegger ORDER BY $sortColumn $sortOrder");
