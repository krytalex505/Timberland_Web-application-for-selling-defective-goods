<?php
require_once '../OperationsUser/SkinaliOperations.php';
...
<head>
    ...
    <title>Скинали, фальшпанели</title>
...
<div class="table-container">
    <table class="table custom-table">
        ...
        <tbody>
        <?php
        $result = $connection->query("SELECT * FROM skinali ORDER BY $sortColumn $sortOrder");
